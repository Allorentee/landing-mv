...
export default function ContentSection() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:max-w-7xl lg:gap-y-10">
          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg" ref={textRefs[0]}>
              ...
              <p className="mt-6 text-xl/8 text-gray-700">
                Con nuestra carta digital, tus clientes podrán consultar el
                menú, filtrar por alérgenos y preferencias, y descubrir los
                platos recomendados de forma rápida y visual. Mejora la gestión
                y la imagen de tu restaurante con tecnología moderna y
                accesible.
              </p>
            </div>
          </div>
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-600 lg:max-w-lg">
              ...
              >
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    No pierdas nunca la información de tu carta gracias a
                    nuestras copias de seguridad diarias.
                  </span>
                </li>
              </ul>
              <p className="mt-8" ref={textRefs[3]}>
                ...
                restaurante. Nuestra carta digital es la herramienta perfecta
                para destacar en el sector de la hostelería.
              </p>
              <h2
